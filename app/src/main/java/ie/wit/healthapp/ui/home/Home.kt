...
import ie.wit.healthapp.databinding.HomeBinding
import ie.wit.healthapp.databinding.NavHeaderBinding
import ie.wit.healthapp.firebase.FirebaseImageManager
import ie.wit.healthapp.ui.auth.LoggedInViewModel
import ie.wit.healthapp.ui.auth.Login
...
class Home : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(setOf(
            R.id.addFragment, R.id.reportFragment, R.id.aboutFragment), drawerLayout)
